...
- [ ] **DECIDIR: la etiqueta MdL/MdA de 2017/18, 2018/19 y 2020/21.** Hallazgo del contraste con el portal: en esas tres temporadas el histórico propio coincide **al 100 %, 84 % y 100 % con la ficha "MACCABI DE ACOSTAR"** y **al 0 % con la de "MACCABI DE LEVANTAR"** (en 2017/18 la coincidencia es jornada a jornada). Dos explicaciones posibles: (a) el club llama "MdL" a lo que el ayuntamiento inscribió como MdA —convención propia—, o (b) esos tres Excel están etiquetados al revés (son los únicos sin sufijo `_MDL`/`_MDA` en el nombre). **No se ha tocado nada.** Si fuese (b), habría que revisar el campo `equipo` de esas tres temporadas; el rendimiento de los jugadores no cambiaría, sólo bajo qué ficha se cuenta.

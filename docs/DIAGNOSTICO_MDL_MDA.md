...
| **2020/21** | **MdA** ⚠ | El Excel anota partidos **contra `MDL` y contra `MACCABI DE LEVANTAR`**. | **MDL** y el tercer equipo `MACCABI DE LEVANTAR`: sólo clasificación |
...
### El detalle de 2020/21: había TRES equipos del club
...
contra `MACCABI DE LEVANTAR` (38-47 y 36-45).
